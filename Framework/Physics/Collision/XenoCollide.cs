...
namespace Spectrum.Framework.Physics.Collision
{
    ...
    public sealed class XenoCollide
    {
             ...
             out Vector3 point, out Vector3 normal, out float penetration)
        {
            ...
            if (v0.LengthSquared() < JMath.Epsilon) v0 = new Vector3(0.00001f, 0, 0);
            ...
            if (normal.LengthSquared() < JMath.Epsilon)
            {
                ...
                Vector3.Dot(ref temp1, ref normal, out penetration);
            ...
            float dist;
            Vector3.Dot(ref normal, ref v0, out dist);
            ...
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    if (normal.LengthSquared() < JMath.Epsilon) return true;
