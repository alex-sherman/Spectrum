...
namespace Spectrum.Framework.Physics.Collision
{
    ...
    public class IslandManager : ReadOnlyCollection<CollisionIsland>
    {
        ...
        private Queue<GameObject> leftSearchQueue = new Queue<GameObject>();
        private Queue<GameObject> rightSearchQueue = new Queue<GameObject>();

        private List<GameObject> visitedBodiesLeft = new List<GameObject>();
        private List<GameObject> visitedBodiesRight = new List<GameObject>();

        private void SplitIslands(GameObject body0, GameObject body1)
        {
            ...
            while (leftSearchQueue.Count > 0 && rightSearchQueue.Count > 0)
            {
                ...
                if (!currentNode.IsStatic)
                {
                    ...
                    {
                        GameObject connectedNode = currentNode.connections[i];
            ...
            if (leftSearchQueue.Count == 0)
            {
                ...
                {
                    GameObject body = visitedBodiesLeft[i];
            ...
            else if (rightSearchQueue.Count == 0)
            {
                ...
                {
                    GameObject body = visitedBodiesRight[i];
        ...
        private void MergeIslands(GameObject body0, GameObject body1)
        {
            if (body0.island != body1.island) // <- both bodies are in different islands
            {
                ...
                else // <- both islands are different,
                {
                    ...
                    GameObject smallIslandOwner, largeIslandOwner;
                    ...
                    foreach (GameObject b in giveBackIsland.bodies)
                    {
