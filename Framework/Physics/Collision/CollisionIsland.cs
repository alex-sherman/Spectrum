...
namespace Spectrum.Framework.Physics.Collision
{
    ...
    public class CollisionIsland
    {
        ...
        internal HashSet<GameObject> bodies = new HashSet<GameObject>();
        ...
        /// </summary>
        public HashSet<GameObject> Bodies { get { return readOnlyBodies; } }

        /// <summary>
        /// Gets a read only list of <see cref="Arbiter"/> which are involved in this island.
        /// </summary>
        public HashSet<Arbiter> Arbiter { get { return readOnlyArbiter; } }

        /// <summary>
        /// Gets a read only list of <see cref="Constraint"/> which are involved in this island.
        /// </summary>
        public HashSet<Constraint> Constraints { get { return readOnlyConstraints; } }

        private HashSet<GameObject> readOnlyBodies;
        private HashSet<Arbiter> readOnlyArbiter;
        private HashSet<Constraint> readOnlyConstraints;

        /// Constructor of CollisionIsland class.
        /// </summary>
        public CollisionIsland()
        {
            readOnlyBodies = new HashSet<GameObject>(bodies);
            readOnlyArbiter = new HashSet<Arbiter>(arbiter);
            readOnlyConstraints = new HashSet<Constraint>(constraints);
        }
