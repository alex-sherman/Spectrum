...
namespace Jitter.Dynamics
{
    ...
    public class RigidBody : IEquatable<RigidBody>, IComparable<RigidBody>
    {
        ...
        internal Matrix inertia;
        internal Matrix invInertia;

        internal Matrix invInertiaWorld;
        internal Matrix orientation;
        internal Matrix invOrientation;
        ...
        public bool ConfineToGround { get; protected set; }
        ...
        public bool IsParticle
        {
            ...
            set
            {
                ...
                else if (!isParticle && value)
                {
                    ...
                    this.invInertia = this.invInertiaWorld = new Matrix();
                    this.invOrientation = this.orientation = Matrix.Identity;
                    inverseMass = 1.0f;
        ...
        public void SetMassProperties(Matrix inertia, float mass, bool setAsInverseValues)
        {
            if (setAsInverseValues)
            {
                if (!isParticle)
                {
                    ...
                    Matrix.Invert(ref inertia, out this.inertia);
                }
            ...
            else
            {
                if (!isParticle)
                {
                    ...
                    Matrix.Invert(ref inertia, out this.invInertia);
                }
        ...
        /// </summary>
        public Matrix Inertia { get { return inertia; } }

        /// <summary>
        /// The inverse inertia currently used for this body.
        /// </summary>
        public Matrix InverseInertia { get { return invInertia; } }
        ...
        /// </summary>
        public Matrix InverseInertiaWorld
        {
            get
            {
        ...
        public float Mass
        {
            ...
            set
            {
                ...
                if (!isParticle)
                {
                    Matrix.Multiply(ref Shape.inertia, value / Shape.mass, out inertia);
                    Matrix.Invert(ref inertia, out invInertia);
                }
